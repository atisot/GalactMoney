...
public class GalactMoneyExpansion extends PlaceholderExpansion {
    ...
    public String onPlaceholderRequest(Player player, String identifier){
        ...
        if(identifier.equals("balance")){
            return format("%d", (int) GalactMoneyAPI.getBalance(player));
        }
        ...
        if(identifier.startsWith("balance_")){
            ...
            try {
                ...
                if(player2 != null) {
                    return format("%d", (int) GalactMoneyAPI.getBalance(player2));
                }
            } catch (Exception e) {
        ...
        if(identifier.equals("rate")){
            return format("%d", (int) GalactMoneyAPI.getExchangeRate());
        }
